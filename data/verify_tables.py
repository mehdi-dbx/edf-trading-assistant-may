#!/usr/bin/env python3
"""Verify Delta tables in UNITY_CATALOG_SCHEMA: flights and turnaround_events exist, CDF enabled on turnaround_events.
...
def main() -> int:
    ...
    if "." not in spec:
        print("FAIL: Set UNITY_CATALOG_SCHEMA to catalog.schema", file=sys.stderr)
        return 1
