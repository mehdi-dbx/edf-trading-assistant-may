...
| What | File | Lines |
|------|------|-------|
| Multimodal input (voice logic + UI) | `e2e-chatbot-app-next/client/src/components/multimodal-input.tsx` | 115-121, 167-240, 392-510 |
| Transcribe API | `e2e-chatbot-app-next/server/src/index.ts` | 21, 25, 197-232 |
| Voice CSS | `e2e-chatbot-app-next/client/src/index.css` | 272-289, 373-376 |
...
- **Ref:** [e2e-chatbot-app-next/server/src/index.ts](e2e-chatbot-app-next/server/src/index.ts) L21, L25

### 2. Transcription Endpoint
Add `POST /api/audio/transcribe` in your Express server (e.g. `server/src/index.ts`).
- **Ref:** [e2e-chatbot-app-next/server/src/index.ts](e2e-chatbot-app-next/server/src/index.ts) L197-232
...
- **Ref:** [e2e-chatbot-app-next/client/src/components/multimodal-input.tsx](e2e-chatbot-app-next/client/src/components/multimodal-input.tsx) L115-121
```ts
...
### 2. Functions
- **Ref:** [multimodal-input.tsx](e2e-chatbot-app-next/client/src/components/multimodal-input.tsx) L167-240
...
- **Ref:** [multimodal-input.tsx](e2e-chatbot-app-next/client/src/components/multimodal-input.tsx) L392-510
...
- **Ref:** [e2e-chatbot-app-next/client/src/index.css](e2e-chatbot-app-next/client/src/index.css) L272-289, L373-376
...
|------|--------------|--------------|
| Backend | `e2e-chatbot-app-next/server/src/index.ts` | `server/src/index.ts` (or equivalent) |
| Frontend | `e2e-chatbot-app-next/client/src/components/multimodal-input.tsx` | Your chat input component |
| CSS | `e2e-chatbot-app-next/client/src/index.css` | Your global CSS |
