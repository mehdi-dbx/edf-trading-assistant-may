...
### Code Location
**CSS:** `e2e-chatbot-app-next/client/src/index.css` (around lines 291–303)
...
**Component:** `e2e-chatbot-app-next/client/src/components/chat-loading-indicator.tsx` (lines 95–99)
...
### Code Location
**Phrases constant:** `e2e-chatbot-app-next/client/src/components/chat-loading-indicator.tsx` (line 3)

```tsx
const STATUS_PHRASES = ['Thinking…', 'Analysing…', 'Almost there…'];
```

**CSS keyframes:** `e2e-chatbot-app-next/client/src/index.css` (lines 332–346)
...
**Component markup:** `e2e-chatbot-app-next/client/src/components/chat-loading-indicator.tsx` (lines 100–117)
...
### Code Location
**Shimmer keyframes:** `e2e-chatbot-app-next/client/src/index.css` (lines 305–330)
...
**Location:** `e2e-chatbot-app-next/client/src/components/message.tsx` (lines 595–605)
...
**Location:** `e2e-chatbot-app-next/client/src/components/messages.tsx` (lines 125–130)
...
| What | File Path |
|------|-----------|
| CSS (dots, shimmer, glow, cycle) | `e2e-chatbot-app-next/client/src/index.css` |
| ChatLoadingIndicator component | `e2e-chatbot-app-next/client/src/components/chat-loading-indicator.tsx` |
| Show in message (streaming) | `e2e-chatbot-app-next/client/src/components/message.tsx` |
| AwaitingResponseMessage | `e2e-chatbot-app-next/client/src/components/message.tsx` |
| Show when submitted | `e2e-chatbot-app-next/client/src/components/messages.tsx` |
