...
If you already have the same `e2e-chatbot-app-next` structure (e.g. from app-templates or amadeus-ground), no code changes are needed. Configure env vars and the existing code will use PAT.
